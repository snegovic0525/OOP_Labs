...
// Вспомогательная функция для сравнения матриц с учетом погрешности
...
// Проверка, что нижняя строка матрицы всегда [0, 0, 1]
...
test("fromTransform: combined behavior", () => {
...
test("invert: round-trip and zero cases", () => {
  const cases = [
